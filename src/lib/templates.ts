...
export const TEMPLATES: TemplateInfo[] = [
  ...
  // ── 8. 鸣潮日常一条龙 (Wuthering Waves Daily) ──
  {
    ...
    description: "Login → tower → claim daily/mail/battle pass (composite nodes)",
    icon: "Swords",
    color: "#6c5ce7",
    workflow: {
      version: "1.0",
      ...
      settings: { run_mode: "once", loop_delay_ms: 0 },
      nodes: [
        { id: "n1", type: "ww_ensure_main", position: { x: 60, y: 100 },
          config: { window_title: "鸣潮", timeout: 180 } },
        { id: "n2", type: "ww_go_to_tower", position: { x: 360, y: 100 },
          config: { window_title: "鸣潮" } },
        { id: "n3", type: "ww_open_daily", position: { x: 660, y: 100 },
          config: { window_title: "鸣潮" } },
        { id: "n4", type: "ww_claim_daily", position: { x: 960, y: 100 },
          config: { window_title: "鸣潮" } },
        { id: "n5", type: "ww_claim_mail", position: { x: 60, y: 300 },
          config: { window_title: "鸣潮" } },
        { id: "n6", type: "ww_claim_battle_pass", position: { x: 360, y: 300 },
          config: { window_title: "鸣潮" } },
        { id: "n7", type: "log", position: { x: 660, y: 300 },
          config: { label: "Daily Task Complete!" } },
      ],
      edges: [
        { id: "e1", source: "n1", sourceHandle: "success", target: "n2", targetHandle: "trigger" },
        { id: "e2", source: "n2", sourceHandle: "success", target: "n3", targetHandle: "trigger" },
        { id: "e3", source: "n3", sourceHandle: "ready",   target: "n4", targetHandle: "trigger" },
        { id: "e4", source: "n4", sourceHandle: "success", target: "n5", targetHandle: "trigger" },
        { id: "e5", source: "n5", sourceHandle: "success", target: "n6", targetHandle: "trigger" },
        { id: "e6", source: "n6", sourceHandle: "success", target: "n7", targetHandle: "value" },
      ],
    },
  },
];
